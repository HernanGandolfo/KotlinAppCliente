...
import com.example.appclient.databinding.FragmentChatBinding
...
class ChatFragment : Fragment(), OnChatListener {
    ...
    // Implemento los cambios en tiempo real
    ...
    //Si Lista no es Vacia , Obtengo el array
    private fun setupRecyclerView(){
        ...
        //Ejemplo para evaluar la posicion de mensaje
        //Tener en cuenta la posicion
        /*(1..20).forEach {
    ...
    //Llamado al Chat readTime , por id de pedido la respuesta pertenece al usuario autentificado
    // Una ves enviado se limpia el campo
